...
const Footerwa = () => {
  return (
    <div className="bg-black w-full ">
      ...
      <div className="w-[95%] mx-auto grid md:grid-cols-3 sm:grid-cols-1 gap-4 py-4">
        ...
        <div
          ...
          //  data-aos-duration="1000"
        >
          <h1 className="hover_animation px-4 text-xl font-semibold mb-7 text-gray-100">
            QUICK <span className="hover:text-[#00b0ea] ">LINKS</span>
          </h1>
          <div className="px-4">
            <li className=" hover:translate-x-3 hover:duration-1000 duration-1000 cursor-pointer list-none py-1">
              <Link
                to="/"
                className="text-[12px] text-gray-100 group-hover:text-gray-300"
              >
                Catalogue
              </Link>
            </li>
        ...
        <div
          ...
          //  data-aos-duration="1000"
        >
          <h1 className=" hover_animation px-4 text-xl font-semibold  uppercase text-gray-100 mb-7">
            Get In <span className="hover:text-[#00b0ea] ">Touch</span>
          </h1>
          <div className="px-4">
            <p className="text-justify text-[12px] text-gray-100 py-1 ">
              A - 164, A Block Noida Sector 63, Gautam Budhha Nagar Uttar
              Pradesh Pincode: 201301
            </p>
            <span className="uppercase text-gray-100 font-semibold text-[14px] py-1">
              India
            </span>
            ...
            <a
              href="mailto:info@erthpot.com"
              target="_blank"
              className="flex items-center gap-2  text-gray-100 text-[12px] py-1"
            >
              <MdMail /> info@erthpot.com
            </a>
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col gap-1 ">
          <p className="text-gray-300 text-[12px] text-center">
            © 2022 Erthpot | Your Indian AV Manufacturing Partner. All rights
            reserved | Website Proudly
          </p>
