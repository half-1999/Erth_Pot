    ...
    return (
        ...
        >
            ...
            >
                ...
                <div>
                    <div className="relative  w-full  p-6 bg-black  shadow-md md:mt-4   mt-96 lg:mt-4 ">
                        ...
                        <div className='mx-auto w-[80%]'>
                            <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className='mb-2'>
                                        ...
                                        <input type='text'
                                            ...
                                            onChange={handleChange}
                                            className='mt-1 p-2 w-full border  outline-none   text-justify'
                                ...
                                <div className=' '>
                                    <button
                                        type="submit"
                                        className="bg-[#00B0EA]  text-white px-4 py-2  hover:bg-[#2d9f9d] "
                                    >
                                        Submit
                                    </button>
