    ...
    const BlogItems = [
        {
            ...
            details: "Make Listening To Music A New Dark Night Delightful Experience Make Listening To Music A New Dark Night Delightful Experience Make Listening To Music A New Dark Night Delightful Experience Make Listening To Music A New Dark Night Delightful Experience Make Listening To Music A New Dark Night Delightful Experience Make Listening To Music A New Dark Night Delightful Experience Make Listening To Music A New Dark Night Delightful Experience",
                ...
                <div className="w-[90vw] mx-auto p-2 ">
                    <div className="grid  md:grid-cols-3 sm:grid-cols-2   p-2 gap-2 ">
                        <div className="col-span-2 ">
                            <div className=" mx-auto mt-10 hover:-translate-y-2 hover:duration-500 duration-500 max-w-[520px] border-2 border-[#00b0ea]  rounded-sm">
                                <img
                                    // src="https://dt-hphone.myshopify.com/cdn/shop/articles/blog-5.jpg?v=1640769435"
                                    src={BlogItems[currentIndex].img}
                                    alt="no-image"
                                />
                            </div>

                            {/* <div className="py-3 px-2 text-[#101930] flex justify-between w-[70%] mx-auto"> */}
                            <div className="py-3 px-2 text-[#101930] grid  md:grid-cols-2 sm:grid-cols-1 gap-2 w-[70%] mx-auto">
                                <div className="flex justify-between text-gray-100">
                                    <span className="text-[12px]  ">{BlogItems[currentIndex].date}</span>
                                    {/* <span className="text-[12px] pl-2">2 Comments</span> */}
                                    <span className="text-[12px] pl-2"><span className="font-semibold">Posted by :</span> {BlogItems[currentIndex].by}</span>
                                </div>
                            ...
                            <div className="px-2  ">
                                <h1 className="text-md text-gray-200 ">
                                    {BlogItems[currentIndex].details}
                                    ...
                                    BlogItems.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <h5 className="text-[#00b0ea]"> {item.date}</h5>
                                            </div>
                                        </div>
                                    ))
                                }
                    ...
                    <div className=" min-h-[600px] w-full flex justify-center items-center ">
                        <div className=" bg-opacity-50 shadow-xl rounded-md">
                            <div className="p-4">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="w-full p-4">
                                    <div className="grid md:grid-cols-2 w-full  gap-4">
                                        <input placeholder="Name" type="text" name="name" value={formData.name} onChange={handleInputChange} className="rounded-full px-2 py-2   outline-[#00b0ea]" />
                                        <input placeholder="Email" type="text" name="email" value={formData.email} onChange={handleInputChange} className="rounded-full px-2 py-2   outline-[#00b0ea]" />
                                    </div>
                                    <div className="py-5 text-center ">
                                        <textarea rows={4} type="text" name="message" value={formData.message} onChange={handleInputChange} className="rounded-md px-2 w-[100%]  outline-[#00b0ea]" placeholder="comments" />
                                    </div>
                                    <div className="text-right">
                                        {/* <button type="submit" className="bg-[#00b0ea] text-white px-3 py-3 border-white border-2 rounded-full text-right hover:bg-[#308180] hover:duration-500 duration-500">
                                Post Comment
                              </button> */}
